...
const url = 'https://654e9880cbc325355742ffed.mockapi.io/app/nutrition';
  ...
  return (
    <div className='mainContent'>
      ...
      <LineChart className='lineChart' width={1450} height={350} data={data}
        ...
        <Line type="monotone" dataKey="totalProteins" stroke="#fdb846" />
        <Line type="monotone" dataKey="totalFat" stroke="#fb78af" />
        <Line type="monotone" dataKey="totalCarbohydrates" stroke="#bcf6a2" />
      </LineChart>
